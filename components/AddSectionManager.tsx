          ...
          <div className="pt-2">
            ...
            <div className="border-b border-slate-200 dark:border-slate-700">
              <nav className="flex -mb-px">
                <TabButton currentMode={mode} targetMode="manual">Añadir Manualmente</TabButton>
                <TabButton currentMode={mode} targetMode="import">Importar de Hoja de Cálculo</TabButton>
              </nav>
            </div>
            <div className="pt-4">
              {mode === 'manual' && (
