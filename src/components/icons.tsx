...
export const WandIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M15 4V2m0 14v-2m-7.5 5.5L6 18m12 0l-1.5-1.5M12 6V2m0 20v-4m-5-1H5m14 0h-2M7 9l-2 2m14-2l-2-2"></path>
...
export const CogIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="m6 3.34 1 1.73"></path>
        <path d="m22 12-2 0"></path>
        <path d="m4 12-2 0"></path>
        <path d="m20.66 7-1.73 1"></path>
        <path d="m3.34 18 1.73-1"></path>
    </svg>
);
