...
// Per @google/genai coding guidelines, the API key must be obtained from process.env.API_KEY.
const API_KEY = process.env.API_KEY;

if (!API_KEY) {
  console.warn("La clave de API de Gemini no se ha encontrado. Las funciones de IA estarán deshabilitadas. Asegúrate de configurar API_KEY en tu entorno.");
}
