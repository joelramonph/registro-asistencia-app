...
import { SaveIcon, PlusCircleIcon, CheckCircleIcon, UserPlusIcon, FolderPlusIcon, ChevronLeftIcon, ChevronRightIcon, DownloadIcon } from './components/icons';
          ...
          <main className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
            <div className="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl shadow-lg mb-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
                <div>
                  <label htmlFor="section-select" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Grado / Sección</label>
                ...
                <div>
                  <label htmlFor="date-select" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Fecha</label>
                  <div className="flex items-center gap-2">
                    <button
                    ...
                    <button
                      ...
                      className="px-4 py-2 text-sm font-semibold rounded-md bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 transition-colors whitespace-nowrap"
                    >
                      Hoy
                    </button>
                  </div>
